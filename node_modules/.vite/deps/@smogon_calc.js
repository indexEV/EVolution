...
var require_moves = __commonJS({
  "node_modules/@smogon/calc/dist/data/moves.js"(exports) {
    ...
    exports.Moves = Moves;
    var Move = (function() {
      function Move2(name, data2, gen2) {
        this.kind = "Move";
        this.id = (0, util_1.toID)(name);
        this.name = name;
        this.flags = {};
        ...
        if (data2.isWind)
          this.flags.wind = 1;
        (0, util_1.assignWithout)(this, data2, Move2.FLAGS);
...
var require_field = __commonJS({
  "node_modules/@smogon/calc/dist/field.js"(exports) {
    ...
    var Field = (function() {
      ...
      Field2.prototype.hasWeather = function() {
        var weathers = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Field2.prototype.hasTerrain = function() {
        var terrains = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Field2.prototype.swap = function() {
        var _a;
  ...
  "node_modules/@smogon/calc/dist/mechanics/util.js"(exports) {
    ...
    function getMoveEffectiveness(gen, move, type, isGhostRevealed, isGravity, isRingTarget) {
      if ((isRingTarget || isGhostRevealed) && type === "Ghost" && move.hasType("Normal", "Fighting")) {
        ...
        return gen.types.get("fighting").effectiveness[type] * gen.types.get("flying").effectiveness[type];
      } else {
...
var require_desc = __commonJS({
  "node_modules/@smogon/calc/dist/desc.js"(exports) {
    ...
    function getKOChance(gen, attacker, defender, move, field, damage, err) {
      ...
      function KOChance(chance2, n, multipleTurns) {
        if (multipleTurns === void 0) {
          multipleTurns = false;
        }
        if (chance2 === 0)
          return { chance: void 0, n, text: qualifier + "not a KO" };
        var text = chance2 === void 0 ? qualifier + "possible " : chance2 === 1 ? qualifier || "guaranteed " : "".concat(qualifier).concat(Math.max(Math.min(Math.round(chance2 * 1e3), 999), 1) / 10, "% chance to ");
        text += n === 1 ? "OHKO" + hazardsText : (multipleTurns ? "KO in ".concat(n, " turns") : "".concat(n, "HKO")) + afterText;
      ...
      if (move.timesUsed === 1 && move.timesUsedWithMetronome === 1 || move.isZ) {
        ...
        if (predictTotal(damage[0], eot.damage, 1, move.timesUsed, toxicCounter, defender.maxHP()) >= defender.curHP() - hazards.damage) {
          ...
          return KOChance(void 0, move.timesUsed, true);
        }
...
var require_gen56 = __commonJS({
  "node_modules/@smogon/calc/dist/mechanics/gen56.js"(exports) {
    ...
    function calculateBWXY(gen, attacker, defender, move, field) {
      ...
      var type2Effectiveness = defender.types[1] ? (0, util_2.getMoveEffectiveness)(gen, move, defender.types[1], isGhostRevealed, field.isGravity) : 1;
      var typeEffectiveness = type1Effectiveness * type2Effectiveness;
    ...
    function calculateBPModsBWXY(gen, attacker, defender, move, field, desc, basePower, hasAteAbilityTypeChange, turnOrder) {
      var bpMods = [];
      var resistedKnockOffDamage = !defender.item || defender.named("Giratina-Origin") && defender.hasItem("Griseous Orb") || defender.name.includes("Arceus") && defender.item.includes("Plate") || defender.name.includes("Genesect") && defender.item.includes("Drive") || defender.named("Groudon", "Groudon-Primal") && defender.hasItem("Red Orb") || defender.named("Kyogre", "Kyogre-Primal") && defender.hasItem("Blue Orb");
    ...
    function calculateAtModsBWXY(attacker, defender, move, field, desc) {
      ...
      if (attacker.hasAbility("Guts") && attacker.status && move.category === "Physical" || attacker.curHP() <= attacker.maxHP() / 3 && (attacker.hasAbility("Overgrow") && move.hasType("Grass") || attacker.hasAbility("Blaze") && move.hasType("Fire") || attacker.hasAbility("Torrent") && move.hasType("Water") || attacker.hasAbility("Swarm") && move.hasType("Bug")) || move.category === "Special" && attacker.abilityOn && attacker.hasAbility("Plus", "Minus")) {
        ...
        desc.attackerAbility = attacker.ability;
        desc.weather = field.weather;
      } else if (field.attackerSide.isFlowerGift && field.hasWeather("Sun", "Harsh Sunshine") && move.category === "Physical") {
        atMods.push(6144);
        desc.weather = field.weather;
        desc.isFlowerGiftAttacker = true;
...
var require_gen789 = __commonJS({
  "node_modules/@smogon/calc/dist/mechanics/gen789.js"(exports) {
    ...
    function calculateSMSSSV(gen, attacker, defender, move, field) {
      ...
      if (!defenderIgnoresAbility && !defender.hasAbility("Poison Heal") && (attackerIgnoresAbility || moveIgnoresAbility)) {
...
var require_pokemon = __commonJS({
  "node_modules/@smogon/calc/dist/pokemon.js"(exports) {
    ...
    var Pokemon = (function() {
      function Pokemon2(gen, name, options) {
        var e_1, _a;
        if (options === void 0) {
          options = {};
        }
        ...
        this.ivs = Pokemon2.withDefault(gen, options.ivs, 31);
        this.evs = Pokemon2.withDefault(gen, options.evs, gen.num >= 3 ? 0 : 252);
        this.boosts = Pokemon2.withDefault(gen, options.boosts, 0, false);
      ...
      Pokemon2.prototype.maxHP = function(original) {
        if (original === void 0) {
          original = false;
        }
      ...
      Pokemon2.prototype.curHP = function(original) {
        if (original === void 0) {
          original = false;
        }
        if (!original && this.isDynamaxed && this.species.baseStats.hp !== 1) {
      ...
      Pokemon2.prototype.hasAbility = function() {
        var abilities = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Pokemon2.prototype.hasItem = function() {
        var items = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Pokemon2.prototype.hasStatus = function() {
        var statuses = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Pokemon2.prototype.hasType = function() {
        var e_2, _a;
        var types = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Pokemon2.prototype.hasOriginalType = function() {
        var e_3, _a;
        var types = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          types[_i] = arguments[_i];
      ...
      Pokemon2.prototype.named = function() {
        var names = [];
        for (var _i = 0; _i < arguments.length; _i++) {
      ...
      Pokemon2.prototype.clone = function() {
        return new Pokemon2(this.gen, this.name, {
          level: this.level,
      ...
      Pokemon2.withDefault = function(gen, current, val, match) {
        if (match === void 0) {
          match = true;
        }
        var cur = {};
...
var require_move = __commonJS({
  "node_modules/@smogon/calc/dist/move.js"(exports) {
    ...
    var Move = (function() {
      function Move2(gen, name, options) {
        if (options === void 0) {
          options = {};
        }
        var _a, _b;
      ...
      Move2.prototype.named = function() {
        var names = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          names[_i] = arguments[_i];
        }
      ...
      Move2.prototype.hasType = function() {
        var types = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          types[_i] = arguments[_i];
        }
      ...
      Move2.prototype.clone = function() {
        return new Move2(this.gen, this.originalName, {
          ability: this.ability,
          item: this.item,
...
//# sourceMappingURL=@smogon_calc.js.map
