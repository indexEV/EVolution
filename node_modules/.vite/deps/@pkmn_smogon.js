...
// node_modules/@pkmn/smogon/build/index.mjs
...
var SPECIAL = /(gen[789](?:vgc20(?:19|2\d)(reg(?:ulation)?[a-z])?|battlestadium(?:singles|doubles)|bs(?:s|d)))(.*)/;
var TRANSLATE = {
...
var Smogon = class _Smogon {
  ...
  match(species, set) {
    ...
    if (species.requiredItems) return species.requiredItems.includes(set.item);
...
//# sourceMappingURL=@pkmn_smogon.js.map
